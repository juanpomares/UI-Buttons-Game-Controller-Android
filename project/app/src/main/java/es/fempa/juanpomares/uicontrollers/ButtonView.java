...
class ButtonView extends View
{
    ...
    public static enum ButtonName {None, Center, Up, Down, Right, Left}
    public static enum ViewType {HorizontalButtonView, VerticalButtonView, PadButtonView}
    public interface ButtonListener
    {
        public void onButtonPress(View v, ButtonName PressedButton);
        public void onButtonHold(View v, ButtonName HoldButton);
    }


    private ButtonListener mButtonListener;
    private boolean mCenterEnabled;
    private int mWidth, mHeight;
    private float MidScreenWidth, MidScreenHeight;

    private float MidButtonWidth, MidButtonHeight;
    private Path mUpButtonPath, mDownButtonPath, mRightButtonPath, mLeftButtonPath, mArrowsPath;


    protected ViewType mViewType;

    public ButtonName mButtonPressed;
    ...
    private void _init()
    {
        ...
        mCenterEnabled=true;
        mWidth=mHeight=0;
        MidScreenWidth=MidScreenHeight =0;
        MidButtonWidth = MidButtonHeight = 25;
        mViewType=ViewType.PadButtonView;
    ...
    public ButtonView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes); _init();
    }

    public ButtonName getPressedButton(){return mButtonPressed;}
    public ButtonListener getButtonListener(){return mButtonListener;}
    public void setButtonListener(ButtonListener _buttonlistener){mButtonListener=_buttonlistener;}
    ...
    private boolean collidesCenterButton(float ex, float ey)
    {
    ...
    private void setPressedButton(ButtonName _button)
    {
        ...
        {
            if(mButtonPressed != ButtonName.None && mButtonListener != null)
                mButtonListener.onButtonHold(this, mButtonPressed);

            mButtonPressed = _button;

            if(mButtonPressed != ButtonName.None && mButtonListener != null)
                mButtonListener.onButtonPress(this, mButtonPressed);
